    ...
    <main>
      <div id="home" class="flex w-full h-screen">
        <div class="flex md:container h-screen w-full overflow-y-scroll">
          <aside
            class="xl:w-1/5 border-r border-lighter dark:border-dark px-0 lg:px-6 py-2 flex flex-col justify-between h-screen sticky top-0 overflow-y-0 no-scrollbar">
            <Sidebar />
          </aside>
