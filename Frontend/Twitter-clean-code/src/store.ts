...
import { ThemeModule } from './views/theme/store'
import { authModule, AuthModule } from './views/auth/store'
import { tweetsModule, TweetsModule } from './views/tweets/store'
import { profileModule, ProfileModule } from './views/user/store'
